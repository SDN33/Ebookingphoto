...
const Services: React.FC<ServicesProps> = ({ onNavigate }) => {
  ...
  return (
    <section className="w-full lg:w-[70vw] h-screen shrink-0 flex flex-col justify-center p-6 md:p-12 lg:px-10 lg:py-8 2xl:px-20 bg-gray-50 snap-start">
      <div className="flex flex-col h-full justify-between py-4 md:py-8">
        ...
        <div className="flex flex-col gap-0">
          {services.items.map((service, idx) => (
            <motion.div 
              ...
              className={`group border-b border-gray-300 py-5 md:py-7 flex flex-col md:flex-col lg:flex-row lg:items-baseline justify-between hover:bg-white hover:px-8 transition-all duration-500 cursor-pointer ${service.path ? 'cursor-pointer' : 'cursor-default'}`}
            >
              <div className="flex flex-col md:flex-col lg:flex-row lg:items-baseline gap-2 md:gap-2 lg:gap-12">
