        ...
        <div className="flex flex-col gap-0">
          {SERVICES.map((service, idx) => (
            <motion.div 
              ...
              className={`group border-b border-gray-300 py-8 md:py-12 flex flex-col md:flex-col lg:flex-row lg:items-baseline justify-between hover:bg-white hover:px-8 transition-all duration-500 cursor-pointer ${service.path ? 'cursor-pointer' : 'cursor-default'}`}
            >
